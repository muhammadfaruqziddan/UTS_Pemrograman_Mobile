...
<body style="background-color: #3498db;">
    <div data-role="page" class="jqm-demos ui-responsive-panel" id="panel-responsive-page1" data-title="Panel responsive page">
        ...
        <div role="main" class="ui-content jqm-content jqm-fullwidth">
            ...
            <h1 style="text-align: center; font-weight:bold; text-transform: uppercase;">Input Data petugas</h1>

            <p></p>
            <div data-demo-html="#panel-responsive-page1" style="justify-content: center;">
                <form class="userform" method="post" action="<?php echo base_url('index.php/C_petugas/Insert');?>">

                    <label for="nama">Nama petugas:</label>
                    <input type="text" name="nama" id="nama" value="" data-clear-btn="true" data-mini="true" required>
                    <label for="telp">Telp petugas:</label>
                    ...
                    <div class="ui-grid-a" style="justify-content: center;">
                        <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_petugas/lihat'); ?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Lihat</a></div><br>
