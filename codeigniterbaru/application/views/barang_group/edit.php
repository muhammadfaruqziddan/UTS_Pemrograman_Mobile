...
<head>
    ...
    <style>
        body {
            background-color: #3498db !important; /* Warna biru */
        }
    </style>
</head>
    ...
    <?php foreach ($data as $dt);?>
    	...
    	<h1
            style="text-align: center;
                   font-weight:bold; 
                   text-transform: uppercase;">Edit Data Barang</h1>

        <p></p>
		<div data-demo-html="#panel-responsive-page1" style="justify-content: center;">
        <form class="userform" method="post" action="<?php echo base_url('index.php/C_barang_group/Update')?>">

            <label for="name">Nama Barang:</label>
            <input type="hidden" value="<?php echo $dt->id_group;?>" name="id_group">
            <input type="text" name="nama_barang" id="nama_barang" value="<?php echo $dt->nama_barang;?>">

            <div class="ui-grid-a" style="justify-content: center;">
                <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_barang_group/lihat');?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Lihat</a></div><br>
                <!-- untuk proses hapus masih kurang scriptnya  $dt->id_group, fungsinya ini utk mengaetahui ID data yang dihapus
                    dan selanjutnya sama fungsi hapus yg ada dicontroller akan ditangkap dengan variabel 
                 $id_group = $this->uri->segment(3); -->
                <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_barang_group/Hapus/').$dt->id_group;?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Haspus</a></div><br>
