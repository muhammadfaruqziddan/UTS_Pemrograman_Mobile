...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/themes/default/jquery.mobile-1.4.5.min.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/_assets/css/jqm-demos.css'); ?>">
...
<div data-role="page" class="jqm-demos ui-responsive-panel" id="panel-responsive-page1" data-title="Panel responsive page">
    ...
    <div role="main" class="ui-content jqm-content jqm-fullwidth">
        ...
        <h1 style="text-align: center; font-weight:bold; text-transform: uppercase;">Input Data Customer</h1>

        <p></p>
        <div data-demo-html="#panel-responsive-page1" style="justify-content: center;">
            <form class="userform" method="post" action="<?php echo base_url('index.php/C_customer/Insert'); ?>">

                <label for="name">Nama Customer:</label>
                <input type="text" name="nama" id="nama" value="" data-clear-btn="true" data-mini="true" required>
                <label for="name">Telp Customer:</label>
                <input type="text" name="telp" id="telp" value="" data-clear-btn="true" data-mini="true" required>
                ...
                <div class="ui-grid-a" style="justify-content: center;">
                    <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_customer/lihat'); ?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Lihat</a></div><br>
